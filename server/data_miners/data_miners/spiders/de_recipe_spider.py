...
class DeNutriRecipeSpider(scrapy.Spider):
    name = "de_nutri_recipe_spider"
    count: int = 0
    data = []
    locale: str = None
    recipe_base_url: str = 'https://www.fitnesszauberin.de/rezept/'
    start_urls: List[str] = ['https://www.fitnesszauberin.de/']
    custom_settings = {
        'DOWNLOAD_DELAY': 0
    }
